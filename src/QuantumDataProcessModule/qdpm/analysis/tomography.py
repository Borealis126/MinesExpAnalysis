...
class StateTomography(object):
    ...
    def _state_projection(self):
        clf = qdpm.TwoQubitClassifier(self._exp, (0, 1))
...
class ProcessTomography(object):
    ...
    def _state_projection(self):
        clf = qdpm.TwoQubitClassifier(self._exp, self._qubit, calib_seq=(0, 1, 2, 3))
...
class QST_chain(StateTomography):
    ...
    def _state_projection(self):
        clf = qdpm.TwoQubitClassifier(self._exp, (0, 1), calib_seq=self._calib_seq)
